            ...
            <div class="row">
                <div class="container my-3 main-container">
                    <div class="row align-items-center">
                        <div class="col">
                            <h2 class="content-color-primary page-title">Exam Form</h2>
                        </div>
                        ...
                        <div class="col-md-10 mx-auto">
                            <div class="row ">
                                <div class="col-lg-12 col-md-12 text-center">
                                    ...
                                    <br>
                                    <p class="text-secondary mt-3">Add New Exam</p>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6">
                                    <label>Subject</label>
                                    <select type="text" class="form-control" data-live-search="true" tabindex="-1" aria-hidden="true">
