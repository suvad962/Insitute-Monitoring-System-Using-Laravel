            ...
            <div class="row">
                <div class="container my-3 main-container">
                    <div class="row align-items-center">
                        <div class="col">
                            <h2 class="content-color-primary page-title">Edit Student Form</h2>
                        </div>
        ...
        <div class="container mt-4 main-container">
            <div class="card mb-4">
                        ...
                        <div class="col-md-10 mx-auto">
                            <div class="row ">
                                <div class="col-lg-12 col-md-12 text-center">
                                    ...
                                    <br>
                                    <p class="text-secondary mt-3">Edit Student</p>
                                </div>
                            </div>
                            <hr>

                            <br>
                            <h5 class="m-0">student Name and Details</h5>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <input type="date" class="form-control" placeholder="<!--API data will Fill This-->">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6">
                            ...
                            <br>
                            <br>
                            <h5 class="m-0">Father's Information</h5>
                            <hr>
                            <div class="form-group row">
                                <div class="col-lg-4 col-md-4">
                            ...
                            <br>
                            <br>
                            <h5 class="m-0">Mother's Information</h5>
                            <hr>
                            <div class="form-group row">
                                <div class="col-lg-4 col-md-4">
                            ...
                            <br>
                            <br>
                            <h5 class="m-0">Others Informtion</h5>
                            <hr>
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6">
                ...
                <div class="card-footer">
                    ...
                    <button class="btn btn-success float-right">Sava</button>
                </div>
            </div>
        </div>
        <!-- content page ends -->
